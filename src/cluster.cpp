// Implementing RANSAC line fitting
                   ...
                   float distanceTolerance)
{
    ...
    // find which points are nearby this pointID
    // "what's nearby within this distance tolerance?"
    std::vector<int> nearest =  tree->search(points[pointID], distanceTolerance);
                                               ...
                                               float distanceTolerance)
{
    ...
    // create a vector the same size as the points vector; all initialised to false
    // keep track of which points have been processed
	...
	while(pointID < points.size())
    {
	    ...
	    std::vector<int> cluster;
	    clusterHelper(pointID, points, cluster, processed, tree, distanceTolerance);
